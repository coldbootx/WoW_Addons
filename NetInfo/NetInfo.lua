-- NetInfo Addon (Classic Only) with Automatic Localization Loader, Colored Messages, and Scrollable UI
...
content:SetWidth(NetInfo:GetWidth() - 80)
...
scrollFrame:SetScript("OnMouseWheel", function(self, delta)
    ...
    local step = 20 -- scroll speed in pixels
...
SlashCmdList["NETINFO"] = function(msg)
    ...
    local function PrintCommand(text) ColorPrint("NetInfo", text) end
